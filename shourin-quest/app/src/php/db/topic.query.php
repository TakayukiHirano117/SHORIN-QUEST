...
class TopicQuery
{
    ...
    public static function insert($topic, $user)
    {
        ...
        if (!($user->isValidId()
            ...
            * $topic->isValidReception())) {
            return false;
        }

        $db = new DataSource;
        $sql = 'insert into topics(title, body, published, reception, user_id) values(:title, :body, :published, :reception, :user_id)';
